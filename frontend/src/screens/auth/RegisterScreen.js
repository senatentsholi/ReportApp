...
export function RegisterScreen({ navigation }) {
  ...
  const updateField = (field, value) => {
    if (field === 'role' && value !== 'student') {
      setForm((current) => ({ ...current, role: value, studentNumber: '', className: '' }));
      return;
    }
        ...
        >
          ...
          <GlassCard>
            ...
            <View style={styles.form}>
              ...
              {form.role === 'student' ? (
                <TextInput mode="outlined" label="Student Number" value={form.studentNumber || ''} onChangeText={(value) => updateField('studentNumber', value)} style={styles.input} theme={inputTheme} />
              ) : null}
              <TextInput mode="outlined" label="Faculty Name" value={form.facultyName} onChangeText={(value) => updateField('facultyName', value)} style={styles.input} theme={inputTheme} />
              <TextInput mode="outlined" label="Department" value={form.department} onChangeText={(value) => updateField('department', value)} style={styles.input} theme={inputTheme} />
              <TextInput mode="outlined" label="Stream / Programme" value={form.streamName} onChangeText={(value) => updateField('streamName', value)} style={styles.input} theme={inputTheme} />
              {form.role === 'student' ? (
                <TextInput mode="outlined" label="Class Name" value={form.className} onChangeText={(value) => updateField('className', value)} style={styles.input} theme={inputTheme} />
              ) : null}
            </View>
